...
// in the fishes array, have objects. each one should have
    //Species
    //Weight
    //Price (between #3 and $10 per fish)
    //Amount (how many were caught today)
...
//create function called boatInventory. it will return the array of fish objects
const boatInventory = () => {
    const newFishArray = []
    for (const fish of fishFromToday) {
        newFishArray.push(fish)
    }

    return newFishArray
}
//newFishArray = boatInventory()

//console.log ({"fishingBoat":newFishArray})
